...
declare type TooltipCallbackFunction = (state: EditorState, dispatch: any, view: EditorView) => any;
declare type ModifierList = Modifier<any, any>[];
declare type GetReferenceElementFunction = (view: EditorView, tooltipDOM: HTMLElement, scrollContainerDOM: HTMLElement) => VirtualElement;
...
declare type SelectionType = string | null;
declare type CalculateTypeFunction = (state: EditorState, prevType: SelectionType) => SelectionType;
...
declare type SuggestTooltipRenderOpts = Omit<TooltipRenderOpts, 'getReferenceElement'>;
